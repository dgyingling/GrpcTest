...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Hello.internal_static_InfoRequest_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Hello.internal_static_InfoRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            InfoRequest.class, InfoRequest.Builder.class);
  }
  ...
  public static InfoRequest parseFrom(
  ...
  public static InfoRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static InfoRequest parseFrom(
  ...
  public static InfoRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static InfoRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static InfoRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(InfoRequest prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using model.InfoRequest.newBuilder()
    private Builder() {
    ...
    public InfoRequest build() {
      InfoRequest result = buildPartial();
    ...
    public InfoRequest buildPartial() {
      InfoRequest result = new InfoRequest(this);
      result.msg_ = msg_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof InfoRequest) {
        return mergeFrom((InfoRequest)other);
      } else {
    ...
    public Builder mergeFrom(InfoRequest other) {
      if (other == InfoRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      InfoRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (InfoRequest) e.getUnfinishedMessage();
  ...
  private static final InfoRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new InfoRequest();
  }
